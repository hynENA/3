...
public class ComputeTax {
	...
	public static void main(String[] args) {
		...
		System.out.print("(0-single filer, l-married jointly or " + "qualifying widow(er), 2-married separately, 3-head of " + "household) Enter the filing status: ");
		...
		if (status == 0) { // Compute tax for single filers
			...
			if (income <= 16700)
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 679000) * 0.25 + (income - 137050) * 0.28;
			else if (income <= 372950)
